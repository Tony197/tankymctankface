...
public class GermanTankStatHeavy : MonoBehaviour
{

    public GermanHeavyChassis hevcas;
    public GermanHeavyChassis timer;
    ...
    {
        //Debug.Log("Cube Hit");
        if ((other.gameObject.tag == "US Medium Round") && attackable)
        {
            Debug.Log("Med Hit");
            health -= mDamage;
        }

        if ((other.gameObject.tag == "US Heavy Round") && attackable)
        {
            Debug.Log("Hev Hit");
            health -= hDamage;
        }

        if ((other.gameObject.tag == "US TD Round") && attackable)
        {
            Debug.Log("TD Hit");
            health -= tdDamage;
        }
