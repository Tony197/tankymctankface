...
public class USMediumChassis : MonoBehaviour
{

    public USTankStatMedium medfiredon;
    public USTankStatMedium hevfiredon;
    public USTankStatMedium tdfiredon;

    public USMedFireMech select;
