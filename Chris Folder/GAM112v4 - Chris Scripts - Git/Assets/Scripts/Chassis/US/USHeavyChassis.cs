...
public class USHeavyChassis : MonoBehaviour
{

    public USTankStatHeavy medfiredon;
    public USTankStatHeavy hevfiredon;
    public USTankStatHeavy tdfiredon;

    public USHevFireMech select;
